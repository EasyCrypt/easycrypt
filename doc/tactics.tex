...
\index{tactics!ambient logic!case@\texttt{case}}
%

\subsection{The \texttt{unfold} tactic}
\index{tactics!ambient logic!unfold@\texttt{unfold}}
%

\subsection{The \texttt{simplify} tactic}
\index{tactics!ambient logic!simplify@\texttt{simplify}}
%

\subsection{The \texttt{trivial} tactic}
\index{tactics!ambient logic!trivial@\texttt{trivial}}
%
...
\index{tactics!Hoare logic!rnd@\texttt{rnd}}

\subsubsection{Probabilistic Hoare Logic}
\index{tactics!probabilistic Hoare logic!rnd@\texttt{rnd}}
\Syntax 
...
\index{tactics!relational Hoare logic!rnd@\texttt{rnd}}

\subsection{Reasoning about sequential composition: the \texttt{seq} tactic}
%
\subsubsection{Hoare Logic}
\index{tactics!Hoare logic!seq@\texttt{seq}}

\subsubsection{Probabilistic Hoare Logic}
\index{tactics!probabilistic Hoare logic!seq@\texttt{seq}}
\Syntax 
...
\subsubsection{Relational Hoare Logic}
\index{tactics!relational Hoare logic!seq@\texttt{seq}}

\subsection{Reasoning about conditionals: the \texttt{if} tactic}
%
\subsubsection{Hoare and Probabilistic Hoare Logic}
\index{tactics!Hoare logic!if@\texttt{if}}
\index{tactics!probabilistic Hoare logic!if@\texttt{if}}
...
\subsubsection{Relational Hoare Logic}
\index{tactics!relational Hoare logic!if@\texttt{if}}

\subsection{Computing weakest preconditions: the \texttt{wp} tactic}
%
\subsubsection{Hoare Logic}
\index{tactics!Hoare logic!wp@\texttt{wp}}

\subsubsection{Probabilistic Hoare Logic}
\index{tactics!probabilistic Hoare logic!wp@\texttt{wp}}
\Syntax \verb+wp+
...
\subsubsection{Relational Hoare Logic}
\index{tactics!relational Hoare logic!wp@\texttt{wp}}

\subsection{Concluding proofs of programs: the \texttt{skip} tactic}
\index{tactics!Hoare logic!skip@\texttt{skip}}
\index{tactics!probabilistic Hoare logic!skip@\texttt{skip}}
\index{tactics!relational Hoare logic!skip@\texttt{skip}}
%

\subsection{Simplifying conditionals: the \texttt{condt,condf} tactic}
%
\subsubsection{Hoare Logic}
\index{tactics!Hoare logic!condt@\texttt{condt}}
\index{tactics!Hoare logic!condf@\texttt{condf}}
...
\subsubsection{Relational Hoare Logic}
\index{tactics!relational Hoare logic!condt@\texttt{condt}}
\index{tactics!relational Hoare logic!condf@\texttt{condf}}
...
%
\subsubsection{Probabilistic Hoare Logic}
\index{tactics!probabilistic Hoare logic!while@\texttt{while}}
