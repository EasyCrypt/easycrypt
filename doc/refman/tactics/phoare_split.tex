...
\begin{tactic}{phoare split}
  ...
  \inferrule*[rightskip=5em]%%
    {\delta_{A} + \delta_{B} - \delta_{AB} \diamond \delta \\%
     ...
     \pHL{P}{c}{A \wedge B}{\symrel{\diamond}}{\delta_{AB}}}%%
    {\pHL{P}{c}{A \vee B}{\diamond}{\delta}}%%
    \quad\raisebox{.7em}{\tct{phoare split $\ \delta_{A}$ $\ \delta_{B}$ $\ \delta_{AB}$}} \\%%
  \inferrule*[rightskip=5em]%%
    {\delta_{A} + \delta_{B} - \delta_{AB} \diamond \delta \\%
     \pHL{P}{c}{A}{\diamond}{\delta_{A}} \\%
     \pHL{P}{c}{B}{\diamond}{\delta_{B}} \\%
     \pHL{P}{c}{A \vee B}{\symrel{\diamond}}{\delta_{AB}}}%%
  ...
  \inferrule*[rightskip=5em]%%
    {\delta_{\top} - \delta_{!} \diamond \delta \\%
     ...
     \pHL{P}{c}{!Q}{\symrel{\diamond}}{\delta_{!}}}%%
    {\pHL{P}{c}{Q}{\diamond}{\delta}}%%
    \quad\raisebox{.7em}{\tct{phoare split $\ {!}$ $\ \delta_{\top}$ $\ \delta_{!}$}} \\%%
  \end{mathpar}
  \end{tsyntax}
  ...
  \inferrule*[rightskip=5em]%%
    ...
    {\pHL{P}{c}{Q}{\diamond}{\delta}}%%
    \quad\raisebox{.7em}{\tct{phoare split $\ \delta_{A}$ $\ \delta_{!A}$: A}} \\%%
  \end{mathpar}
  \end{tsyntax}  
\end{tactic}
