...
\begin{tactic}{phoare split}
  ...
  \inferrule%%
    ...
    \quad\mbox{(\phl)\quad\parbox{200pt}{\ec{phoare split $\ \delta_{A}$ $\ \delta_{B}$ $\ \delta_{AB}$}}} \\%%
  \inferrule%%
    {\delta_{A} + \delta_{B} - \delta_{AB} \diamond \delta \\%
     \pHL{P}{c}{A}{\diamond}{\delta_{A}} \\%
     \pHL{P}{c}{B}{\diamond}{\delta_{B}} \\%
  ...
  \inferrule%%
    ...
    \quad\mbox{(\phl)\quad\parbox{200pt}{\ec{phoare split $\ {!}$ $\ \delta_{\top}$ $\ \delta_{!}$}}} \\%%
  \end{mathpar}
  \end{tsyntax}
  ...
  \inferrule%%
    ...
    {\pHL{P}{c}{Q}{\diamond}{\delta}}%%
    \quad\mbox{(\phl)\quad\parbox{200pt}{\ec{phoare split $\ \delta_{A}$ $\ \delta_{!A}$: A}}} \\%%
  \end{mathpar}
  \end{tsyntax}  
\end{tactic}
