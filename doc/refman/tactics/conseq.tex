...
\begin{tactic}{conseq}
  ...
  \inferrule%%
    {P' \Rightarrow P \\%
     ...
     \pRHL{P}{c}{c'}{Q}}%%
    {\pRHL{P'}{c}{c'}{Q'}}%%
    \quad\mbox{(\prhl)\quad\parbox{200pt}{\ec{conseq (_: P ==> Q)}}} \\
  \inferrule%%
    {Q \Rightarrow Q' \\%
     \pRHL{P'}{c}{c'}{Q}}%%
    {\pRHL{P'}{c}{c'}{Q'}}%%
    \quad\mbox{(\prhl)\quad\parbox{200pt}{\ec{conseq (_: _ ==> Q)}}} \\
  \inferrule%%
    ...
    {\pHL{P'}{c}{Q'}{\diamond}{\delta'}}%%
    \quad\mbox{(\phl)\quad\parbox{200pt}{\ec{conseq (_: P ==> Q: $\;\delta$)}}} \\
  \inferrule%%
    {P' \Rightarrow P \\%
     Q \Rightarrow Q' \\%
     \HL{P}{c}{Q}}%%
    {\HL{P'}{c}{Q'}}%%
    \quad\mbox{(\hl)\quad\parbox{200pt}{\ec{conseq (_: P ==> Q)}}} \\
  \end{mathpar}
  ...
  \begin{mathpar}
    ...
    {P' \Rightarrow \delta \mathrel{=} \delta' \\%
     ...
     \pHL{P}{c}{Q}{=}{\delta}}%%
    {\pHL{P'}{c}{Q'}{\leq}{\delta'}}%%
    \quad\mbox{(\phl)\quad\parbox{200pt}{\ec{conseq (_: P ==> Q: $\;\mathop{=}\delta$)}}} \\
  \end{mathpar}  
  \end{tsyntax}
  ...
  \inferrule%%
    {P' \Rightarrow P \wedge \inmem{P_1}{1} \wedge \inmem{P_2}{2} \\%
     ...
     \pRHL{P}{c_1}{c_2}{Q}}%%
    {\pRHL{P'}{c_1}{c_2}{Q'}}%%
    \quad\mbox{(\prhl)\quad\parbox{200pt}{\ec{conseq (_: P ==> Q) (_: P$_1$ ==> Q$_1$) (_: P$_2$ ==> Q$_2$)}}}
  \end{mathpar}
  \end{tsyntax}
  ...
  \inferrule%%
    {P' \Rightarrow P \\%
     ...
     \pHL{P_1}{c}{Q_1}{=}{1}}
    {\pRHL{P'}{c}{\Skip}{Q'}}%%
    \quad\mbox{(\prhl)\quad\parbox{200pt}{\ec{conseq (_: P ==> Q) (_: P$_1$ ==> Q$_1$: =1$\%$r)}}} \\
  \inferrule%%
    {P \Rightarrow P_2 \\%
     Q_2 \Rightarrow Q \\%
     \pHL{P_2}{c}{Q_2}{=}{1}}
    {\pRHL{P}{\Skip}{c}{Q}}%%
    \quad\mbox{(\prhl)\quad\parbox{200pt}{\ec{conseq (_: _ ==> _) _ (_: P$_2$ ==> Q$_2$: =1$\%$r)}}}
  \end{mathpar}
  \end{tsyntax}
