...
\begin{tactic}{while}
  ...
  a weakest precondition computation over a loop using \tct{I} as
  invariant. This generates two subgoals: one explaining that \tct{I}
  ...
  Where \tct{v} is an integer-valued expression. In \phl, performs a
  weakest precondition computation over a loop, using \tct{I} as
  invariant and \tct{v} as a decreasing variant to prove
  ...
  \textbf{Note:} More complex variants of the \tct{while} tactic
