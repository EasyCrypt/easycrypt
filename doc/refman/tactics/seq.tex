...
\begin{tactic}{seq}
  ...
  \inferrule%%
    ...
    \quad\mbox{(\prhl)\quad\parbox{200pt}{\ec{seq $\ \left|c_1\right|$ $\ \left|c_2\right|$: R}}}\\%%
  \end{mathpar}
  \end{tsyntax}
  ...
  \inferrule%%
    {\HL{P}{c}{R}\\%%
     \HL{R}{c'}{Q} }%%
    {\HL{P}{c;c'}{Q}}%%
    \quad\mbox{(\hl)\quad\parbox{200pt}{\ec{seq $\ \left|c\right|$: R}}}\\%%
  \end{mathpar}
  \end{tsyntax}
  ...
  \inferrule%%
    ...
    \quad\mbox{(\phl)\quad\parbox{200pt}{\ec{seq $\ \left|c\right|$: R $\ \delta_1$ $\ \delta_2$ $\ \delta_3$ $\ \delta_4$ I}}}\\%%
  \inferrule%%
    {\HL{P}{c}{\mathsf{true}} \\%
     \pHL{P}{c}{R}{\diamond}{\delta_1}  \\%
     \pHL{R \wedge I}{c'}{Q}{\diamond}{\delta_2} \\%
    ...
    {\pHL{P}{c;c'}{Q}{\diamond}{\delta}}%%
    \quad\mbox{(\phl)\quad\parbox{200pt}{\ec{seq $\ \left|c\right|$: R $\ \delta_1$ $\ \delta_2$ _ $0$}}}\\%%
  \end{mathpar}
