...
%  procnamestyle={\sffamily\itshape},
  ...
  morekeywords=[7]{idtac,change,beta,iota,zeta,logic,delta,simplify,congr,generalize,pose,split,left,right,case,intros,cut,elim,apply,rewrite,elimT,subst,progress,trivial},
  morekeywords=[8]{by,assumption,smt},
  morekeywords=[9]{first,last},
...
\lstdefinestyle{easycrypt-default}{
  ...
  keywordstyle=[7]{\itshape\color{Blue}},
  keywordstyle=[8]{\itshape\color{Red}},
  keywordstyle=[9]{\itshape\color{Green}},
  literate={phi}{{$\!\phi\,$}}1
           {phi1}{{$\!\phi_1$}}1
           {phi2}{{$\!\phi_2$}}1
           {phi3}{{$\!\phi_3$}}1
