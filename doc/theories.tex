...
With modules and functors in place, it is now possible to express properties
...
\footnote{From Francois: it may be worth considering the use of
another arrow symbol (for example $\Rrightarrow$) for contracts.}}
...
\warningbox{This feature is not yet fully documented.}

\section{Working with Theories\label{sec:cloning}}

Theories can be cloned and refined using the \ec{clone} keyword, which creates
