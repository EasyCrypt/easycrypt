...
Theorem while_rule_rec : forall (e:expr) (inv:fmla) (i:stmt),
  ...
  (sqt:(map ident Z)) (l:stmt), (many_steps s l sqt Sskip) -> ((l = (Swhile e
  i)) -> ((eval_fmla s inv) -> (eval_fmla sqt (Fand (Fnot (Fterm e)) inv)))).
(* YOU MAY EDIT THE PROOF BELOW *)
unfold valid_triple; intros e inv i Hinv_preserved.
induction 1.
Focus 2.
