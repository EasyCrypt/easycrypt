...
lemma L4 : forall (f : 'a -> bool) x1 x2,
  x1 = x2 => f x1 = f x2.
proof. by intros=> f x1 x2 eq_x; congr. qed.
...
proof. by intros=> f x1 x2 y1 y2 eq_x eq_y; congr. qed.

lemma L7 : forall (f : 'a -> 'b -> 'c -> bool) x1 x2 y1 y2 z1 z2,
  x1 = x2 => y1 = y2 => z1 = z2 => f x1 y1 z1 = f x2 y2 z2.
proof. by intros=> f x1 x2 y1 y2 z1 z2 eq_x eq_y eq_z; congr. qed.
