...
proof.
  elim/nat_ind n => {n}; first by rewrite nseqO size_nil.
...
proof.
  elim/nat_ind n => {n}; first by rewrite nth_O_Nil.
...
proof.
  elim/nat_ind n => {n}; first by rewrite subOO.
...
proof.
  rewrite /le; generalize n; elim/list_ind l => {l}.
    by intros=> n; rewrite nth_nil.
  intros=> y ys IH n; elim/nat_ind n => {n}.
