...
lemma test (x : zq): x <> ofint 0 => inv x = inv x.
proof. by move=> h; fieldeq. qed.

lemma b24 (a b c: zq):
    a = b =>
    c = (ofint 2) * a =>  
    c ^^ 2 = Zq.( * )( b ^^ 2) (ofint 4).
proof. by move=> h1 h2; fieldeq h1 h2. qed.

(* FIXME: parser/printer do not agree *)
...
proof. by intros=> h; split; fieldeq; smt. qed.
