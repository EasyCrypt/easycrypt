...
lemma if_ : hoare [Test.if_ : true ==> res=1]. fun.
sp.
if; [| skip;trivial].
while (x=1); sp; skip; trivial.
qed.

lemma eq : hoare [Test.eq : true ==> res]. fun.
sp.
skip; trivial.
qed.

lemma eq_ : hoare [Test.eq : true ==> res]. fun.
...
lemma eq__ : equiv [Test.eq ~ Test.eq : true ==> res{1}]. fun.
sp 1 1.
sp 1 0.
sp.
skip; trivial.
...
lemma eq_equiv : hoare [Test.eq : true ==> res]. fun.
wp 1.
sp.
skip; trivial.
qed.
