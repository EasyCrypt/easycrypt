...
theory LazyEager.
  ...
  section.
    ...
    + transitivity{1} {
      ...
      rewrite get_set_eqE //= eq_except_sym; first exact/eq_except1Sm.
      move=> /= mL mR.
      by rewrite in_fset0=> /= -> /= + -> - ->.
    wp; while (={x,work} /\
               IND_Eager.H.m{1} = IND_Lazy.H.m{2} /\
  ...
  theory OnLog.
    ...
    section.
      ...
      + proc; inline RO.o; auto=> /> //= &1 &2 x2_notin_qs eq_qs_m eqe y _.
        rewrite !inE !get_setE x2_notin_qs /= oget_some eq_exceptSS_eq //= eq_sym.
        split.
      ...
      + inline RO.o; auto.
        ...
        by rewrite get_set_eqE // oget_some /= eq_except1Sm /= eq_qs_m /#.
