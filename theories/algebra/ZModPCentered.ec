...
(* ==================================================================== *)
abstract theory ZpCenteredRing.
...
clone import ZModP.ZModField as ZMF.
clone include ZpCenteredRing with theory ZMR <= ZMF.
import ZMR.

(* ZMR is a field here, so prime_p (from ZModField) is in scope, and the
   ring-level centered content (to_crepr/crepr/creprD/...) is reused. *)
