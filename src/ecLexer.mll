(* -------------------------------------------------------------------- *)
{
  ...
  let _keywords = [                     (* see [keywords.py] *)
    ...
    "res"         , RES        ;        (* KW: prog *)
    "equiv"       , EQUIV      ;        (* KW: prog *)
    "dcoupl"      , DCOUPL     ;        (* KW: prog *)
    "delay"       , DELAY      ;        (* KW: tactic *)
    "undelay"     , UNDELAY    ;        (* KW: tactic *)
    "push"        , PUSH       ;        (* KW: tactic *)
    "pop"         , POP        ;        (* KW: tactic *)
    "frame"       , FRAME      ;        (* KW: tactic *)
    "indep"       , INDEP      ;        (* KW: tactic *)
    "trans"       , TRANS      ;        (* KW: tactic *)
    "cond"        , COND       ;        (* KW: tactic *)
    "prod"        , PROD       ;        (* KW: tactic *)
    "asgn"        , ASGN       ;        (* KW: tactic *)
    "intro"       , INTRO      ;        (* KW: tactic *)
    "hoare"       , HOARE      ;        (* KW: prog *)
