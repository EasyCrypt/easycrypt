...
module Low = struct
  ...
  let t_hoare_rcond_r b at_pos tc =
    ...
    let concl1  = f_hoareS_old hs.hs_m hs.hs_pr hd e in
    let concl2  = f_hoareS_old hs.hs_m hs.hs_pr s hs.hs_po in
  ...
  let t_bdhoare_rcond_r b at_pos tc =
    ...
    let concl1  = f_hoareS_old bhs.bhs_m bhs.bhs_pr hd e in
...
module LowMatch = struct
  ...
  let t_hoare_rcond_match_r c at_pos tc =
    ...
    let concl1  = f_hoareS_old hs.hs_m hs.hs_pr hd po1 in
    let concl2  = f_hoareS_old me pr full hs.hs_po in
  ...
  let t_bdhoare_rcond_match_r c at_pos tc =
    ...
    let concl1 = f_hoareS_old bhs.bhs_m bhs.bhs_pr hd po1 in
  ...
  let t_equiv_rcond_match_r side c at_pos tc =
    ...
    let concl1 =
      f_forall_mems [mo', EcMemory.memtype mo]
        (f_hoareS_old (EcFol.mhr, EcMemory.memtype m) pre1 hd po1) in
