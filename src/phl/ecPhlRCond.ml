...
module Low = struct
  ...
  let t_hoare_rcond_r b at_pos tc =
    ...
    let e = {hsi_m=e.m;hsi_inv=(e.inv,epost,d)} in
  ...
  let t_ehoare_rcond_r b at_pos tc =
    ...
    let e = {hsi_m=e.m;hsi_inv=empty_poe e.inv} in
    ...
    let concl1 =
      EcSubst.f_forall_mems_ss_inv (EcIdent.create "&m", snd mo)
        (ts_inv_lower_side2 (fun pr po ->
          ...
          let po = {hsi_m=po.m;hsi_inv=empty_poe po.inv} in
...
module LowMatch = struct
  ...
  let t_hoare_rcond_match_r c at_pos tc =
    ...
    let (_,eposts,d) = (hs_po hs).hsi_inv in
    let po1 = {hsi_m=po1.m;hsi_inv=(po1.inv,eposts,d)} in
  ...
  let t_bdhoare_rcond_match_r c at_pos tc =
    ...
    let po1 ={hsi_m=po1.m;hsi_inv=empty_poe po1.inv} in
