...
val process_cost     : ?mv:metavs -> LDecl.hyps -> pcost    -> ty -> cost
...
val pf_process_cost     : proofenv -> ?mv:metavs -> LDecl.hyps -> ty -> pcost -> cost
...
val tc1_process_cost     : ?mv:metavs -> tcenv1 -> ty -> pcost -> cost
