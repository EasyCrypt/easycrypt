...
(* Why obligation from file "easycrypt34b8bd.why", line 772, characters 0-5485: *)
(*Why goal*) Lemma implies_goal102 : 
  (forall (skey_426_2019:(map public_key secret_key)),
   (forall (skey_355_2018:(map public_key secret_key)),
    (forall (seed_428_2017:(map (prod message public_key) eph_key)),
     (forall (seed_357_2016:(map (prod message public_key) eph_key)),
      (forall (s_474_2015:session_id),
       (forall (s_397_2014:session_id),
        (forall (complete_sessions_422_2013:(map (prod public_key message) session_descr)),
         (forall (complete_sessions_351_2012:(map (prod public_key message) session_descr)),
          (forall (LH_427_2011:(map session_string session_key)),
           (forall (LH_356_2010:(map session_string session_key)),
            (forall (G_430_2009:(map session_id session_key)),
             ((invariant1 LH_356_2010 LH_427_2011) ->
              ((invariant2 G_430_2009 LH_356_2010 skey_426_2019 seed_428_2017) ->
               ((invariant3
                 G_430_2009 LH_356_2010 LH_427_2011 skey_426_2019 seed_428_2017) ->
                (skey_355_2018 = skey_426_2019 ->
                 (seed_357_2016 = seed_428_2017 ->
                  (complete_sessions_351_2012 = complete_sessions_422_2013 ->
                   (s_397_2014 = s_474_2015 ->
                    (forall (h_3_622:session_key),
                     let A_475_621 := (fstpart s_474_2015) in
                     let B_476_620 := (sndpart s_474_2015) in
                     let X_477_619 := (fstmsg s_474_2015) in
                     let Y_478_618 := (sndmsg s_474_2015) in
                     ((in_dom_map
                       (pair A_475_621 X_477_619) complete_sessions_422_2013) =
                      true ->
                      let B'_480_617 :=
                        (session_part
                         (get_map
                          complete_sessions_422_2013 (pair
                      ...
                      (B_476_620 = B'_480_617 ->
                       (Y_478_618 = Y'_481_616 ->
                        ((in_dom_map
                          (pair B_476_620 Y_478_618) complete_sessions_422_2013) =
                         true ->
                         let sidB_495_600 :=
                           (mk_sid
                         ...
                         (~sidA_494_615 =
                          ...
                          (~(session_test_flag
                           ...
                           (~(isSome_id
                              (findelse_sid_abs
                               G_430_2009 sidA_494_615 skey_426_2019 seed_428_2017)) =
                             true ->
                            (~(isSome_string
                               (findelse_h_abs
                                LH_427_2011 sidA_494_615 skey_426_2019 seed_428_2017)) =
                              true ->
                             let A_398_575 := (fstpart s_397_2014) in
                             let B_399_574 := (sndpart s_397_2014) in
                             let X_400_573 := (fstmsg s_397_2014) in
                             let Y_401_572 := (sndmsg s_397_2014) in
                             ((in_dom_map
                               (pair A_398_575 X_400_573) complete_sessions_351_2012) =
                              true ->
                              let B'_403_571 :=
                                (session_part
                                 (get_map
                                  complete_sessions_351_2012 (pair
                              ...
                              (B_399_574 = B'_403_571 ->
                               (Y_401_572 = Y'_404_570 ->
                                ((in_dom_map
                                  (pair B_399_574 Y_401_572) complete_sessions_351_2012) =
                                 true ->
                                 let s'_530_566 :=
                                   (mk_sid
                                    B_399_574 (session_part
                                               (get_map
                                                complete_sessions_351_2012 (
                                  ...
                                  (~(session_test_flag
                                   ...
                                   let sstr_411_560 :=
                                     (gen_session_string_sid
                                      (mk_sid
                                       A_398_575 B'_403_571 X_400_573 Y'_404_570) skey_355_2018 seed_357_2016) in
                                   (~(in_dom_map sstr_411_560 LH_356_2010) =
                                     true ->
                                    (invariant2
                                     (upd_map G_430_2009 sidA_494_615 h_3_622) (
                                     upd_map LH_356_2010 sstr_411_560 h_3_622) skey_426_2019 seed_428_2017))))))))))))))))))))))))))))))))))).
Proof.
 ...
 unfold invariant2.
 intros.
 destruct (findelse_g_abs_some _ _ _ _ _ H21).
apply not_eq_sym.
apply None_neq_Some.
assert (sstr_411_560 = gen_session_string_sid
                    sidA_494_615 skey_355_2018 seed_357_2016).
unfold sidA_494_615, sstr_411_560.
...
assert (str_514 = gen_session_string_sid (fer_sid_513) skey_426_2019
     seed_428_2017) by (rewrite (eqS_def1 _ _ _ _  H22);auto).


destruct ((proj1 (in_dom_upd_map _ _ _ _ _ _) H23)).
rewrite H26 in *.

assert (sstr_411_560 = str_514) by (rewrite H24, H25, H2, H3;auto).

rewrite H27, upd_map_dom_same, !get_upd_map_same;split;auto.

destruct (session_id_eq_dec fer_sid_513 sidA_494_615).
rewrite H27 in *.
assert (sstr_411_560 = str_514) by (rewrite H24, H25, H2, H3;auto).
rewrite H28, upd_map_dom_same, !get_upd_map_same;split;auto.

destruct (session_string_eq_dec sstr_411_560  str_514).

destruct (Some_or_None _ (findelse_sid_abs G_430_2009 sidA_494_615 skey_426_2019
             seed_428_2017));[idtac|destruct H29;rewrite H29,isSome_id_def1 in H12;elim H12;auto].

destruct (findelse_sid_abs_none1 _ _ _ _ H29   _ H26).

apply same_string_def2.
rewrite <- H25, <- H28, <- H2, <- H3;auto.

rewrite upd_map_dom_diff,!get_upd_map_diff;auto.
apply H0.

rewrite  (findelse_g_update_2 _ _ _ _ ) in H21;auto.
rewrite <- H2, <- H3, <- H24.
