...
(* Why obligation from file "easycryptf249b2.why", line 772, characters 0-4210: *)
(*Why goal*) Lemma implies_goal55 : 
  (forall (skey_426_1381:(map public_key secret_key)),
   (forall (skey_355_1380:(map public_key secret_key)),
    (forall (seed_428_1379:(map (prod message public_key) eph_key)),
     (forall (seed_357_1378:(map (prod message public_key) eph_key)),
      (forall (s_474_1377:session_id),
       (forall (s_397_1376:session_id),
        (forall (complete_sessions_422_1375:(map (prod public_key message) session_descr)),
         (forall (complete_sessions_351_1374:(map (prod public_key message) session_descr)),
          (forall (LH_427_1373:(map session_string session_key)),
           (forall (LH_356_1372:(map session_string session_key)),
            (forall (G_430_1371:(map session_id session_key)),
             ((invariant1 LH_356_1372 LH_427_1373) ->
              ((invariant2 G_430_1371 LH_356_1372 skey_426_1381 seed_428_1379) ->
               ((invariant3
                 G_430_1371 LH_356_1372 LH_427_1373 skey_426_1381 seed_428_1379) ->
                (skey_355_1380 = skey_426_1381 ->
                 (seed_357_1378 = seed_428_1379 ->
                  (complete_sessions_351_1374 = complete_sessions_422_1375 ->
                   (s_397_1376 = s_474_1377 ->
                    (forall (h_3_622:session_key),
                     let A_475_621 := (fstpart s_474_1377) in
                     let B_476_620 := (sndpart s_474_1377) in
                     let X_477_619 := (fstmsg s_474_1377) in
                     let Y_478_618 := (sndmsg s_474_1377) in
                     ((in_dom_map
                       (pair A_475_621 X_477_619) complete_sessions_422_1375) =
                      true ->
                      let B'_480_617 :=
                        (session_part
                         (get_map
                          complete_sessions_422_1375 (pair
                      ...
                      (B_476_620 = B'_480_617 ->
                       (Y_478_618 = Y'_481_616 ->
                        (~(in_dom_map
                           (pair B_476_620 Y_478_618) complete_sessions_422_1375) =
                          true ->
                         (~(session_test_flag
                            (get_map
                             complete_sessions_422_1375 (pair
                          ...
                          (~(isSome_id
                             (findelse_sid_abs
                              G_430_1371 sidA_494_615 skey_426_1381 seed_428_1379)) =
                            true ->
                           (~(isSome_string
                              (findelse_h_abs
                               LH_427_1373 sidA_494_615 skey_426_1381 seed_428_1379)) =
                             true ->
                            let A_398_575 := (fstpart s_397_1376) in
                            let B_399_574 := (sndpart s_397_1376) in
                            let X_400_573 := (fstmsg s_397_1376) in
                            let Y_401_572 := (sndmsg s_397_1376) in
                            ((in_dom_map
                              (pair A_398_575 X_400_573) complete_sessions_351_1374) =
                             true ->
                             let B'_403_571 :=
                               (session_part
                                (get_map
                                 complete_sessions_351_1374 (pair
                             ...
                             (B_399_574 = B'_403_571 ->
                              (Y_401_572 = Y'_404_570 ->
                               (~(in_dom_map
                                  (pair B_399_574 Y_401_572) complete_sessions_351_1374) =
                                 true ->
                                (~(session_test_flag
                                   (get_map
                                    complete_sessions_351_1374 (pair
                                 ...
                                 let sstr_411_557 :=
                                   (gen_session_string_sid
                                    (mk_sid
                                     A_398_575 B'_403_571 X_400_573 Y'_404_570) skey_355_1380 seed_357_1378) in
                                 (~(in_dom_map sstr_411_557 LH_356_1372) =
                                   true ->
                                  (invariant2
                                   (upd_map G_430_1371 sidA_494_615 h_3_622) (
                                   upd_map LH_356_1372 sstr_411_557 h_3_622) skey_426_1381 seed_428_1379))))))))))))))))))))))))))))))))).
...
Proof.
 ...
 unfold invariant2.
 intros.
 destruct (findelse_g_abs_some _ _ _ _ _ H19).
apply not_eq_sym.
apply None_neq_Some.
destruct ((proj1 (in_dom_upd_map _ _ _ _ _ _) H21)).
rewrite H22, Proj_Some in *.


assert (sstr_411_557 = str_514).
unfold sstr_411_557.
rewrite <- (eqS_def1 _ _ _ _ H20), <- H22, H2, H3.
unfold sidA_494_615.
...
rewrite <- H22, <- H23, !get_upd_map_same;auto.
...
assert (sstr_411_557 = str_514).
unfold sstr_411_557.
rewrite <- (eqS_def1 _ _ _ _ H20), H23 , H2, H3.
unfold sidA_494_615.
rewrite <- H7, <- H8, <- H14, <- H15.
unfold B_399_574, Y_401_572, A_398_575,  X_400_573.
unfold B_476_620, Y_478_618, A_475_621, X_477_619. 
...
rewrite <- H23, <- H24, !get_upd_map_same;auto.

destruct (session_string_eq_dec sstr_411_557  str_514).


destruct (Some_or_None _ ( findelse_sid_abs G_430_1371 sidA_494_615 skey_426_1381
             seed_428_1379));
[idtac |
destruct H25;
rewrite H25, isSome_id_def1 in H11;elim H11;auto].

destruct (findelse_sid_abs_none1 _ _ _ _ H25   _ H22).
apply same_string_def2.
rewrite (eqS_def1 _ _ _ _ H20), <- H24.
unfold sstr_411_557.
unfold sidA_494_615.

rewrite <- H14, <- H15, <- H7, <- H8.
...
rewrite  (findelse_g_update_2 _ _ _ _ ) in H19;auto.
cut (gen_session_string_sid sidA_494_615 skey_426_1381 seed_428_1379 = sstr_411_557).
intro Heq; rewrite Heq; apply not_eq_sym;auto.
