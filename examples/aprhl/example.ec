...
declare axiom adv_pure (m : glob A): hoare [A.adv : glob A = m ==> glob A = m].
declare axiom adv_ll : islossless A.adv.
...
+ rewrite addrK sumr_const count_predT size_range lez_maxr //.
